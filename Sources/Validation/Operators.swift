...
public func && <L: Validator, R: Validator>(lhs: L, rhs: R) -> ValidatorList<L.Input> where L.Input == R.Input {
...
public func && <R: Validator>(lhs: ValidatorList<R.Input>, rhs: R) -> ValidatorList<R.Input> {
...
public func && <L: Validator>(lhs: L, rhs: ValidatorList<L.Input>) -> ValidatorList<L.Input> {
    let list = ValidatorList<L.Input>()
...
public func && <I: Validatable>(lhs: ValidatorList<I>, rhs: ValidatorList<I>) -> ValidatorList<I> {
